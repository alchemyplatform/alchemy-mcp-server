...
export function registerTools(server: McpServer, alchemyApi: AlchemyApi) {
  ...
  }, handleToolCall((params) => alchemyApi.getTokensByMultichainAddress(params), 'fetchTokensOwnedByMultichainAddresses'));
  ...
  }, handleToolCall((params) => alchemyApi.getAssetTransfers(params), 'fetchTransfers'));
  ...
  }, handleToolCall((params) => alchemyApi.getNftsForAddress(params), 'fetchNftsOwnedByMultichainAddresses'));
  ...
  server.tool('fetchNftContractDataByMultichainAddress', {
    ...
    withMetadata: z.boolean().default(true).describe('Whether to include metadata in the results.'),
  }, handleToolCall((params) => alchemyApi.getNftContractsByAddress(params), 'fetchNftContractDataByMultichainAddress'));
  ...
  }, handleToolCall((params) => alchemyApi.sendTransaction(params), 'sendTransaction'));
