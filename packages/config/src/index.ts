...
export function validateRequiredEnvVars() {
  ...
  // Note: ETHERSCAN_API_KEY is optional but required for contract ABI operations
  if (!ETHERSCAN_API_KEY) {
    console.warn('⚠️  ETHERSCAN_API_KEY is not set. Contract ABI operations (fetchContractAbi) will not function.');
  }
